...
class pbBlockValueSortProcessor extends modObjectProcessor
{
     ...
     * @param array $where
     */
    public function sort(pbBlockValue $source, pbBlockValue $target, $where = [])
    {
